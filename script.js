...
function createCactus(){
    ...
    let dinoAndar = setInterval(() => {
        let dino1 = 'url(imagens/dino.png)';
        let dino2 = 'url(imagens/dino2.png)';
    ...
    function gameStop(score){
        ...
        document.getElementById('avisoPontos').innerHTML = "But you did " + score + " points! :)";
...
function acenderLuz(){
    ...
    document.getElementById('lampadaApagada').style.display = 'none';
    document.getElementById('lampadaAcesa').style.display = 'block';
...
function apagarLuz(){
    ...
    document.getElementById('lampadaApagada').style.display = 'block';
    document.getElementById('lampadaAcesa').style.display = 'none';
